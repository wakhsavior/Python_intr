...
__all__ = [
    'DISPID_SPRsItem', 'SRTStandard', 'SPPS_Noun',
    'DISPID_SpeechXMLRecoResult', 'SPLEXICONTYPE', 'DISPID_SPAsCount',
    'DISPID_SVPriority', 'SPGS_ENABLED', 'SPEI_SR_BOOKMARK',
    'SpeechAudioVolume', 'DISPID_SLPPartOfSpeech',
    'DISPID_SRGCmdSetRuleIdState', 'LONG_PTR', 'SVPAlert',
    'DISPID_SRGCmdLoadFromMemory', 'SPRECOCONTEXTSTATUS',
    'eLEXTYPE_RESERVED7', 'SpeechRecognizerState',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SRCreateRecoContext',
    'DISPID_SpeechCustomStream', 'SpeechWordType',
    'ISpPhoneConverter', 'ISpProperties',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SABIEventBias',
    'DISPID_SPIGetText', 'DISPID_SVAudioOutput',
    'DISPID_SVSInputSentencePosition', 'DISPID_SPRText', 'SPBO_PAUSE',
    'DISPID_SpeechBaseStream', 'SpeechCategoryAudioOut',
    'SpeechCategoryVoices', 'ISpeechBaseStream',
    'SDA_Two_Trailing_Spaces', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SPIAudioSizeTime', 'eLEXTYPE_PRIVATE15', 'SP_VISEME_11',
    'SPGRAMMARSTATE', 'SAFT12kHz16BitMono', 'DISPID_SOTIsUISupported',
    'eLEXTYPE_PRIVATE20', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SRGReset', 'SPCT_COMMAND', 'DISPID_SGRSAddWordTransition',
    'SpeechVoiceEvents', 'DISPID_SPARecoResult', 'DISPID_SLPLangId',
    'ISpeechRecoResultDispatch', 'DISPID_SPIAudioSizeBytes',
    'ISpeechLexiconPronunciation', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SRAudioInputStream', 'SpeechStreamSeekPositionType',
    'SREInterference', 'SAFT11kHz16BitMono',
    'DISPID_SVSInputWordLength', 'DISPID_SpeechVoiceStatus',
    'SPPHRASEELEMENT', 'DISPID_SPELexicalForm',
    'SAFTCCITT_ALaw_11kHzMono', 'SASRun', 'SECLowConfidence',
    'DISPID_SRSAudioStatus', 'SAFTText', 'SDTLexicalForm',
    'SP_VISEME_16', 'eLEXTYPE_PRIVATE7', 'SAFT11kHz8BitMono',
    'tagSTATSTG', 'SREStreamStart', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SRCEHypothesis', 'SDTAlternates', 'SBONone',
    'SpUnCompressedLexicon', 'eLEXTYPE_PRIVATE6',
    'DISPID_SABufferNotifySize', 'SAFT32kHz16BitStereo',
    'SpeechFormatType', 'DISPID_SASNonBlockingIO',
    'DISPID_SpeechGrammarRuleState', 'SDTAll', 'SRADynamic',
    'eLEXTYPE_RESERVED8', 'SPFILEMODE', 'DISPID_SASetState',
    'DISPIDSPTSI_SelectionLength', 'SAFT16kHz16BitStereo',
    'SAFT48kHz16BitMono', 'SPCT_SUB_COMMAND', 'ISpRecoContext2',
    'SPWORDPRONUNCIATIONLIST', 'SVP_17', 'DISPID_SpeechRecoContext',
    'DISPID_SVSpeakStream', 'DISPID_SRSSupportedLanguages',
    'SPPHRASE', 'SREPrivate', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SPRuleConfidence', 'ISpeechPhraseProperty',
    'DISPID_SPRuleEngineConfidence', 'SINoSignal',
    'SAFTCCITT_uLaw_22kHzMono', '__MIDL_IWinTypes_0009',
    'DISPID_SPRNumberOfElements', 'SPPS_RESERVED4', 'SPWF_INPUT',
    'SAFT48kHz16BitStereo', 'SP_VISEME_8', 'DISPID_SPRuleName',
    'DISPID_SOTs_NewEnum', 'SP_VISEME_19', 'DISPID_SRRSaveToMemory',
    'eLEXTYPE_RESERVED9', 'SREBookmark', 'DISPID_SGRName',
    'SGSExclusive', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SVVoice', 'SRAExport', 'SSSPTRelativeToStart',
    'DISPID_SpeechFileStream', 'SPPARTOFSPEECH',
    'SpeechGrammarRuleStateTransitionType', 'SP_VISEME_20',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SLGetWords',
    'DISPID_SPPsCount', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPSSuppressWord', 'SpCompressedLexicon', 'DISPID_SVEViseme',
    'SPAUDIOBUFFERINFO', 'ISpeechPhraseInfoBuilder',
    'DISPID_SRCESoundEnd', 'SECFDefault',
    'DISPID_SRCCreateResultFromMemory', 'SDTReplacement',
    'ISpeechGrammarRuleState', 'SRSEIsSpeaking', 'SpStream',
    'SPEI_MIN_TTS', 'SAFTDefault', 'Speech_Max_Pron_Length',
    'DISPID_SOTCId', 'SPSInterjection', 'DISPID_SGRSTransitions',
    'SVEAllEvents', 'SpeechPropertyHighConfidenceThreshold',
    'ISpStreamFormat', 'SPRST_ACTIVE', 'SPEI_RECO_OTHER_CONTEXT',
    'SpeechSpecialTransitionType', 'SPRS_ACTIVE_USER_DELIMITED',
    'SDA_One_Trailing_Space', 'DISPID_SOTGetAttribute',
    'DISPID_SPILanguageId', 'SPWT_DISPLAY', 'DISPID_SVRate',
    'SVSFUnusedFlags', 'SFTInput', 'ISpeechObjectTokens',
    'DISPID_SRSetPropertyNumber', 'SVEViseme', 'DISPID_SRStatus',
    'SpeechLoadOption', 'SPPS_Noncontent', 'SpShortcut', 'SLTApp',
    'SAFTADPCM_44kHzMono', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SGRsDynamic', 'DISPID_SRRecognizer', 'SSFMCreateForWrite',
    'ISpeechGrammarRule', 'SVP_19', 'SPADAPTATIONRELEVANCE',
    'ISpShortcut', 'DISPID_SGRs_NewEnum', 'DISPID_SOTDisplayUI',
    'SP_VISEME_13', 'DISPID_SLPSymbolic', 'DISPID_SPRs_NewEnum',
    'SGDisplay', 'SPRS_ACTIVE', 'SPWT_LEXICAL',
    'DISPIDSPTSI_SelectionOffset', 'SAFT12kHz8BitStereo',
    'DISPID_SRProfile', 'DISPID_SPIReplacements',
    'DISPID_SLAddPronunciation', 'DISPID_SVEWord',
    'SPEI_START_SR_STREAM', 'DISPID_SVEVoiceChange',
    'DISPID_SLGenerationId', 'SPPS_Function', 'SPRULE',
    'SPGRAMMARWORDTYPE', 'DISPID_SVAudioOutputStream',
    'DISPID_SPEsItem', 'DISPID_SpeechGrammarRule',
    'SPSTREAMFORMATTYPE', 'SPINTERFERENCE_NOISE',
    'SSSPTRelativeToCurrentPosition', 'SpeechRegistryUserRoot',
    'ISpeechAudio', 'DISPID_SDKGetBinaryValue', 'SECFEmulateResult',
    'SpeechAddRemoveWord', 'DISPID_SpeechLexiconWord',
    'SAFT32kHz8BitMono', 'SPEI_RESERVED1', 'DISPID_SGRSTPropertyName',
    'DISPID_SPIStartTime', 'DISPID_SPAsItem', 'SRATopLevel',
    'SpPhoneConverter', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SpeechPhraseAlternates', 'eLEXTYPE_PRIVATE13',
    'SAFT11kHz8BitStereo', 'DISPID_SLAddPronunciationByPhoneIds',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SVF_None',
    'DISPID_SRCERequestUI', 'IInternetSecurityManager',
    'ISpeechVoiceStatus', 'IStream', 'DISPID_SDKDeleteKey', 'SVP_21',
    'DISPID_SPIProperties', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SpeechLexiconWords', 'ISpeechObjectTokenCategory',
    'SP_VISEME_6', 'SREFalseRecognition', 'DISPID_SPIElements',
    'DISPID_SADefaultFormat', 'DISPID_SRCERecognitionForOtherContext',
    'SpeechTokenContext', 'ISpeechRecognizerStatus',
    'ISpeechMMSysAudio', 'SITooSlow', 'SPPS_RESERVED3',
    'DISPID_SVGetProfiles', 'DISPID_SVEStreamEnd', 'DISPID_SOTSetId',
    'DISPID_SLRemovePronunciation', 'ISpMMSysAudio', 'SREAudioLevel',
    'Speech_StreamPos_RealTime', 'SGDSInactive', 'eLEXTYPE_PRIVATE8',
    'SpeechEngineConfidence', 'SRERecoOtherContext',
    'SpeechGrammarTagWildcard', 'DISPID_SPIEnginePrivateData',
    'DISPID_SPRuleChildren', 'DISPID_SpeechPhraseElements',
    'SpNullPhoneConverter', 'SPSLMA', 'DISPID_SpeechLexicon',
    'DISPID_SLPs_NewEnum', 'SECFNoSpecialChars', 'DISPIDSPTSI',
    'DISPID_SRCRequestedUIType', 'SpMMAudioIn',
    'DISPID_SRRGetXMLResult', 'SPPS_Modifier', 'ISpRecognizer3',
    'DISPID_SOTMatchesAttributes', 'ISpSerializeState',
    'DISPID_SRCEEndStream', 'DISPID_SVSkip', 'SVSFPurgeBeforeSpeak',
    'SPEI_SOUND_END', 'eLEXTYPE_PRIVATE17', 'DISPID_SPEPronunciation',
    'DISPID_SWFEExtraData', 'DISPID_SRCERecognition', 'eLEXTYPE_APP',
    'DISPID_SRRPhraseInfo', 'ISpeechPhoneConverter',
    'DISPID_SGRSTPropertyValue', 'DISPID_SGRAddResource',
    'SpeechAudioState', 'SPPS_Unknown', 'SpTextSelectionInformation',
    'DISPID_SPRDisplayAttributes', 'SVP_5', 'DISPID_SPPFirstElement',
    'SpeechCategoryRecoProfiles', 'ISpRecoResult',
    'DISPID_SGRSTs_NewEnum', 'SPRECORESULTTIMES',
    'SAFT11kHz16BitStereo', 'DISPID_SRCBookmark',
    'DISPID_SPEActualConfidence', 'SGRSTTWildcard', 'SRSInactive',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPSNotOverriden',
    'DISPID_SPEEngineConfidence', 'SPCS_DISABLED',
    'DISPID_SPAStartElementInResult', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SVGetAudioInputs', 'SAFT44kHz16BitStereo', 'SVP_8',
    'DISPID_SDKGetlongValue', 'DISPID_SLGetPronunciations',
    'SGLexical', 'DISPID_SGRSTType', 'eWORDTYPE_ADDED', 'SPXRO_SML',
    '_ISpeechVoiceEvents', 'SGSDisabled', 'SGRSTTDictation',
    'SDKLDefaultLocation', 'SVP_1', 'SPWF_SRENGINE', 'SP_VISEME_0',
    'DISPID_SVSyncronousSpeakTimeout',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SRERequestUI',
    'SpeechVoiceSpeakFlags', 'ISpeechRecoResult2', 'SVP_15',
    'eLEXTYPE_PRIVATE11', 'DISPIDSPRG', 'SP_VISEME_3',
    'SVSFVoiceMask', 'DISPID_SRGRules', 'SPEI_MAX_SR',
    'SPSHT_NotOverriden', 'SGSEnabled', 'ISpeechXMLRecoResult',
    'SRERecognition', 'DISPID_SRCEAudioLevel', 'SSFMCreate',
    'ISpeechWaveFormatEx', 'eLEXTYPE_PRIVATE12',
    'ISpeechPhraseReplacements', 'Speech_StreamPos_Asap',
    'STSF_LocalAppData', 'SpeechRetainedAudioOptions',
    'SVEAudioLevel', 'DISPID_SpeechRecognizerStatus',
    'SpeechAudioFormatType', 'ISpPhoneticAlphabetConverter',
    'DISPID_SPPValue', 'SPEVENT', 'DISPID_SRRTStreamTime',
    'DISPID_SpeechPhraseProperties', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SOTsItem', 'SPCT_SLEEP', 'SP_VISEME_15',
    'DISPID_SOTCEnumerateTokens', 'SSFMOpenForRead', 'SPSHT_EMAIL',
    'SPEI_PROPERTY_NUM_CHANGE', 'SpeechGrammarState',
    'SVEEndInputStream', 'SP_VISEME_12', 'ISpResourceManager',
    'DISPID_SRCEAdaptation', 'SPAO_NONE', 'DISPID_SAStatus',
    'DISPID_SASCurrentDevicePosition', 'SpeechRecoProfileProperties',
    'DISPID_SpeechAudioFormat', 'SAFT12kHz16BitStereo',
    'SPBO_TIME_UNITS', 'ISpNotifySink',
    'ISpeechGrammarRuleStateTransition', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SGRSAddRuleTransition', 'SpMMAudioOut',
    'ISpeechRecoContext', 'ISpeechRecoResult', 'DISPID_SFSOpen',
    'SGRSTTTextBuffer', 'SpeechDictationTopicSpelling',
    'SVSFlagsAsync', 'SpSharedRecoContext', 'SpeechEngineProperties',
    'DISPID_SABIBufferSize', 'SAFT12kHz8BitMono', 'SPAS_STOP',
    'DISPID_SVSVisemeId', 'ISpeechRecognizer', 'SPEI_END_SR_STREAM',
    'SpeechRecognitionType', 'DISPID_SRGRecoContext',
    'SPEI_PHRASE_START', 'DISPID_SLWWord', 'DISPID_SRCPause',
    'DISPID_SPAs_NewEnum', 'ISpeechPhraseAlternates',
    'DISPID_SAFType', 'ISpeechRecoGrammar', 'ISpeechAudioStatus',
    'SVP_7', 'SpeechAudioProperties', 'SPAUDIOSTATE',
    'DISPID_SVAlertBoundary', 'SPEI_RECOGNITION',
    'ISpeechGrammarRules', 'DISPID_SOTCGetDataKey', 'SVP_6',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SRCEEnginePrivate',
    'DISPID_SpeechLexiconPronunciation', 'STSF_CommonAppData',
    'SPEI_HYPOTHESIS', 'ISpeechLexiconPronunciations',
    'DISPID_SpeechGrammarRules', 'DISPID_SVEBookmark',
    'ISpeechLexiconWords', 'SASPause', 'SREPropertyStringChange',
    'SGDSActiveWithAutoPause', 'DISPID_SGRSTRule', 'SPCATEGORYTYPE',
    'SPINTERFERENCE', 'SAFT32kHz8BitStereo', 'SPSUnknown',
    'ISpeechResourceLoader', 'SpeechAudioFormatGUIDWave',
    'Speech_Default_Weight', 'SPEI_START_INPUT_STREAM',
    'SVSFParseSsml', 'SVSFNLPMask', 'DISPID_SDKOpenKey',
    'DISPID_SpeechPhoneConverter', 'SAFTADPCM_11kHzMono',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SVIsUISupported',
    'SPRST_INACTIVE', 'SpeechRegistryLocalMachineRoot', 'SVP_11',
    'SRESoundStart', 'DISPID_SRGDictationUnload', 'SVP_18',
    'DISPID_SOTsCount', 'SpeechVoicePriority',
    'DISPID_SPEAudioSizeTime', 'DISPID_SVSRunningState',
    'SpeechAllElements', 'DISPID_SRGCommit',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SGRSRule',
    'SPSHORTCUTPAIRLIST', 'SRESoundEnd', 'DISPID_SOTCreateInstance',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SpeechLexiconProns',
    'DISPID_SGRSTsItem', 'SWTDeleted',
    'DISPID_SpeechGrammarRuleStateTransition', 'SRTSMLTimeout',
    'SVSFParseMask', 'SSTTDictation',
    'ISpeechTextSelectionInformation', 'SPDKL_CurrentConfig',
    'DISPID_SPISaveToMemory', 'SPEI_RESERVED5', 'SVSFIsNotXML',
    'SPAO_RETAIN_AUDIO', 'eLEXTYPE_RESERVED10',
    'DISPID_SASCurrentSeekPosition', 'SPSEMANTICERRORINFO',
    'DISPID_SRGSetTextSelection', 'SAFTADPCM_8kHzMono',
    'ISpeechLexicon', 'SPPS_Interjection', 'DISPID_SpeechRecoResult',
    'SPRST_ACTIVE_ALWAYS', 'ISpeechCustomStream', 'SPEVENTENUM',
    'SpeechBookmarkOptions', 'DISPID_SOTCSetId',
    'SpStreamFormatConverter', 'DISPID_SPEDisplayText', 'SVP_10',
    'SINone', 'ISpEventSink', 'STCLocalServer',
    'ISpeechRecoResultTimes', 'DISPID_SCSBaseStream',
    'DISPID_SVEEnginePrivate', 'SITooLoud', 'ISpDataKey',
    'SpeechRecoEvents', '_SPAUDIOSTATE', 'SRTReSent',
    'ISpeechFileStream', 'SpeechInterference', 'SWTAdded',
    'SSTTWildcard', 'SPFM_CREATE_ALWAYS', 'DISPID_SPPName',
    'DISPID_SGRSTNextState', 'SPCT_DICTATION',
    'SpPhoneticAlphabetConverter', 'DISPID_SVWaitUntilDone',
    'SPSMF_UPS', 'DISPID_SVPause', 'DISPID_SOTGetDescription',
    'SpeechMicTraining', 'DISPID_SLWPronunciations',
    'DISPID_SpeechPhraseProperty', 'ISpXMLRecoResult',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SRDisplayUI',
    'SAFTCCITT_uLaw_11kHzStereo', 'SpeechRuleState',
    'SPPHRASEPROPERTY', 'DISPID_SpeechPhraseRules',
    'SpeechPropertyAdaptationOn', 'DISPID_SLPsItem',
    'STCInprocHandler', 'DISPID_SGRsCommit',
    'DISPID_SRGetPropertyNumber', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SpeechPhraseInfo', 'DISPID_SGRsItem', 'STCInprocServer',
    'DISPID_SRRSpeakAudio', 'DISPID_SRCEStartStream',
    'DISPID_SpeechRecognizer', 'SP_VISEME_17', 'DISPID_SpeechDataKey',
    'ISpRecoGrammar', 'DISPID_SBSRead', 'DISPID_SMSSetData',
    'DISPID_SVEPhoneme', 'SWPUnknownWordPronounceable',
    'DISPID_SDKGetStringValue', 'SP_VISEME_9',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SAFT24kHz16BitMono',
    'DISPID_SVSInputWordPosition', 'SPAR_Medium',
    'eLEXTYPE_RESERVED6', 'SAFT22kHz8BitStereo', 'DISPID_SAVolume',
    'DISPID_SMSADeviceId', 'SGDSActiveUserDelimited',
    'DISPID_SOTGetStorageFileName', 'eLEXTYPE_VENDORLEXICON',
    ...
    'SRTExtendableParse', 'SPEI_ADAPTATION', 'SAFT24kHz8BitMono',
    'DISPID_SLWLangId', 'SpInprocRecognizer', 'DISPID_SRRTimes',
    'SPPS_Verb', 'DISPID_SpeechObjectTokens', 'DISPID_SpeechAudio',
    'SAFTADPCM_11kHzStereo', 'SAFT44kHz16BitMono', 'SPFM_CREATE',
    'SDTPronunciation', 'SAFTADPCM_44kHzStereo', 'DISPID_SRCState',
    '_RemotableHandle', 'SVP_9', 'SPSHT_Unknown', 'SDTRule',
    'SpeechEmulationCompareFlags', 'DISPID_SpeechPhraseRule',
    'DISPID_SRSCurrentStreamNumber', 'SpSharedRecognizer',
    'eLEXTYPE_USER', 'DISPID_SDKDeleteValue', 'SpeechTokenValueCLSID',
    'DISPID_SRCSetAdaptationData', 'ISpeechPhraseElement',
    'DISPID_SpeechPhraseReplacements', 'SVPOver', 'ISpeechPhraseRule',
    'SP_VISEME_4', 'SDA_Consume_Leading_Spaces', 'STCAll',
    'SpPhraseInfoBuilder', 'SVESentenceBoundary', 'SVP_3',
    'DISPID_SLPType', 'SpeechLexiconType', 'DISPID_SRGState',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SVGetAudioOutputs',
    'eLEXTYPE_PRIVATE10', 'SAFTNoAssignedFormat',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SDKSetStringValue',
    'SPDATAKEYLOCATION', 'DISPID_SABIMinNotification',
    'SPBINARYGRAMMAR', 'ISpRecoGrammar2', 'DISPID_SWFESamplesPerSec',
    'SpObjectToken', 'DISPID_SGRClear', 'SREStateChange',
    'SPSMF_SAPI_PROPERTIES', 'ISpVoice', 'DISPID_SWFEChannels',
    'DISPID_SPANumberOfElementsInResult', 'SPAR_Low',
    'SWPUnknownWordUnpronounceable', 'SITooQuiet', 'SPAS_CLOSED',
    'DISPID_SPRuleParent', 'ISpRecognizer2', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SGRSTText', 'eLEXTYPE_PRIVATE4', 'SVP_0',
    'DISPID_SMSGetData', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SRRTOffsetFromStart', 'eLEXTYPE_RESERVED4',
    'DISPID_SRGetPropertyString', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SLWsCount', 'SPAUDIOSTATUS', 'SAFTExtendedAudioFormat',
    'SAFTCCITT_ALaw_22kHzStereo', 'SINoise', 'eLEXTYPE_PRIVATE19',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SECFIgnoreCase',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SGRId', 'SVSFIsFilename',
    'ISpeechDataKey', 'ISpNotifySource', 'SPEI_SOUND_START',
    'SFTSREngine', 'ISpeechPhraseElements', 'SPEI_SR_PRIVATE',
    'DISPID_SPPConfidence', 'DISPID_SPEs_NewEnum',
    'DISPID_SOTRemoveStorageFileName', 'SPPROPERTYINFO',
    'SRTEmulated', 'DISPID_SGRsFindRule', 'DISPID_SPPsItem',
    'SPEI_UNDEFINED', 'SpeechCategoryAudioIn',
    'SPEI_END_INPUT_STREAM', 'SpeechCategoryRecognizers',
    'SPWT_PRONUNCIATION', 'ISpeechPhraseReplacement',
    ...
    'DISPID_SpeechPhraseAlternate', 'Speech_Max_Word_Length',
    'DISPID_SpeechPhraseBuilder', 'ISpeechAudioFormat',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SpeechAudioStatus',
    'DISPID_SPIGrammarId', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SOTCDefault', 'DISPID_SRCResume', 'SRTAutopause',
    'ISequentialStream', 'DISPID_SRRAlternates', 'SVP_14',
    'DISPID_SVVolume', 'DISPID_SLWType', 'SPSHORTCUTTYPE',
    'DISPID_SGRsCount', 'SAFT16kHz8BitStereo',
    'ISpeechAudioBufferInfo', 'SRAONone', 'DISPID_SFSClose',
    'SPEI_RESERVED2', 'DISPID_SOTDataKey', 'SP_VISEME_1',
    'SpeechCategoryAppLexicons', 'SASStop',
    'DISPID_SPRuleFirstElement', 'SVSFParseAutodetect',
    'SDA_No_Trailing_Space', 'SAFTNonStandardFormat',
    'SpCustomStream', 'SRSActiveAlways', 'SPDKL_DefaultLocation',
    'eLEXTYPE_PRIVATE1', 'SPCT_SUB_DICTATION', 'SGRSTTWord',
    'SRSInactiveWithPurge', 'SRAInterpreter', 'DISPID_SABufferInfo',
    'DISPID_SPPId', 'SDKLCurrentUser', 'SpeechPropertyResponseSpeed',
    'SPEI_FALSE_RECOGNITION', 'SpInProcRecoContext',
    'DISPID_SPRulesItem', 'SpeechTokenKeyAttributes',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SOTCategory',
    'ISpeechPhraseInfo', 'SPPS_SuppressWord',
    'DISPID_SpeechPhraseElement', 'SGDSActive', 'ISpRecoCategory',
    'SPAS_PAUSE', 'SAFT48kHz8BitMono',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SPEDisplayAttributes', 'SLOStatic',
    'SpObjectTokenCategory', 'SPSERIALIZEDPHRASE',
    'SAFTCCITT_uLaw_8kHzMono', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SPRuleId', 'SAFTGSM610_22kHzMono', 'SAFTGSM610_44kHzMono',
    'SRADefaultToActive', 'DISPID_SVSCurrentStreamNumber',
    'SECFIgnoreWidth', 'DISPID_SRRTTickCount', 'SVF_Emphasis',
    'ISpeechPhraseAlternate', 'DISPID_SWFEBlockAlign',
    'DISPID_SGRSTsCount', 'ISpeechMemoryStream',
    'SpeechCategoryPhoneConverters', 'SpeechTokenKeyFiles',
    'SREStreamEnd', 'SRSEDone', 'SPSHT_OTHER', 'SPPS_NotOverriden',
    'SP_VISEME_18', 'SpeechAudioFormatGUIDText',
    'DISPID_SPRuleNumberOfElements', 'SpeechWordPronounceable',
    'SpeechTokenShellFolder', 'DISPID_SRRSetTextFeedback',
    'eLEXTYPE_PRIVATE5', 'eLEXTYPE_LETTERTOSOUND', 'SPSNoun',
    'DISPID_SPEsCount', 'DISPID_SRGSetWordSequenceData', 'SVP_20',
    'eLEXTYPE_PRIVATE2', '_ISpeechRecoContextEvents',
    'SpeechGrammarTagDictation', 'SDTAudio', 'SAFT44kHz8BitMono',
    'DISPID_SVSInputSentenceLength', 'SVSFParseSapi', 'SLODynamic',
    'SPGS_DISABLED', 'SECFIgnoreKanaType', 'SVP_13', 'SVPNormal',
    'DISPIDSPTSI_ActiveLength', 'SPRS_INACTIVE',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SAFT48kHz8BitStereo',
    'SPAR_Unknown', 'DISPID_SVSLastBookmark', 'ISpGrammarBuilder',
    'DISPID_SRRAudioFormat', 'SPPHRASEREPLACEMENT', 'SDTProperty',
    'SPEI_REQUEST_UI', 'ISpObjectToken', 'SPVPRI_OVER',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SRGCmdLoadFromFile',
    'SPWAVEFORMATTYPE', 'SRAORetainAudio', 'SPEI_MIN_SR',
    'DISPID_SLWs_NewEnum', 'SpeechDataKeyLocation',
    'DISPID_SGRAttributes', 'DISPID_SLGetGenerationChange',
    'DISPID_SVResume', 'SVEPrivate', 'DISPID_SGRsAdd',
    'ISpeechLexiconWord', 'DISPID_SRCEventInterests', 'SRCS_Enabled',
    'SPEI_SENTENCE_BOUNDARY', 'SREPropertyNumChange',
    'SpeechDiscardType', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SPIGetDisplayAttributes', 'IInternetSecurityMgrSite',
    'SAFT24kHz16BitStereo', 'ISpEventSource', 'SAFTADPCM_8kHzStereo',
    'DISPID_SBSWrite', 'SDKLLocalMachine', 'SPVPRIORITY',
    'eLEXTYPE_PRIVATE18', 'DISPID_SVSLastBookmarkId',
    'DISPID_SDKEnumValues', 'DISPID_SRState',
    'DISPID_SAFGetWaveFormatEx', 'SPWORDLIST', 'DISPID_SVSLastResult',
    'SPAUDIOOPTIONS', 'SPEI_TTS_AUDIO_LEVEL', 'ISpeechObjectToken',
    'SAFTCCITT_ALaw_11kHzStereo', 'SP_VISEME_7',
    'SPEI_RECO_STATE_CHANGE', 'SVP_12', 'DISPID_SOTId',
    'DISPID_SBSSeek', 'ISpStreamFormatConverter',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SVSpeak',
    'SPSERIALIZEDRESULT', 'SPFM_OPEN_READWRITE', 'SPXMLRESULTOPTIONS',
    'SECNormalConfidence', 'DISPID_SMSAMMHandle', 'SPVPRI_NORMAL',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SPRulesCount',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPTEXTSELECTIONINFO', 'SPINTERFERENCE_NONE', 'SPSVerb',
    'SVSFIsXML', 'SPEI_VISEME', 'SLTUser', 'IEnumSpObjectTokens',
    'SSSPTRelativeToEnd', 'SITooFast', 'SpAudioFormat',
    'DISPID_SVESentenceBoundary', 'DISPID_SREmulateRecognition',
    'SpeechRecoContextState', 'SpeechUserTraining',
    'DISPID_SGRAddState', 'SpMemoryStream', 'DISPID_SPRsCount',
    'SSFMOpenReadWrite', 'SRARoot', 'SAFT22kHz8BitMono',
    'SPVPRI_ALERT', 'DISPID_SRCVoice', 'STSF_FlagCreate',
    'SPEI_WORD_BOUNDARY', 'SpeechGrammarWordType',
    'DISPID_SVSLastStreamNumberQueued', 'eLEXTYPE_PRIVATE14',
    'SPEI_INTERFERENCE', 'DISPID_SPPs_NewEnum',
    'SPXRO_Alternates_SML', 'SPRST_NUM_STATES', 'SGPronounciation',
    'SAFT8kHz16BitStereo', 'WAVEFORMATEX', 'SPEI_RESERVED6',
    'SpeechTokenKeyUI', 'DISPID_SDKEnumKeys', 'DISPID_SAEventHandle',
    'SAFT24kHz8BitStereo', 'DISPID_SVDisplayUI', 'DISPID_SGRSTWeight',
    'SECHighConfidence', 'SPPS_RESERVED2',
    'DISPID_SPERequiredConfidence', 'DISPID_SPCIdToPhone',
    'SpeechStreamFileMode', 'SPFM_NUM_MODES',
    'SpeechTokenIdUserLexicon', 'SAFTCCITT_uLaw_8kHzStereo',
    'SpResourceManager', 'DISPID_SGRSTPropertyId', 'SVF_Stressed',
    'SVEVoiceChange', 'SVSFDefault', 'DISPID_SRAudioInput',
    'ISpLexicon', 'SPRECOGNIZERSTATUS', 'DISPID_SVStatus',
    'SpeechRuleAttributes', 'SWPKnownWordPronounceable',
    'SPLOADOPTIONS', 'ISpObjectWithToken', 'DISPID_SRIsShared',
    'DISPID_SpeechMMSysAudio', 'SPEI_MAX_TTS', 'DISPID_SRRAudio',
    'SPWORD', 'DISPID_SGRsCommitAndSave', 'DISPID_SAFSetWaveFormatEx',
    'SPSModifier', 'ISpPhoneticAlphabetSelection',
    'eLEXTYPE_PRIVATE9', 'SPPS_RESERVED1', 'SPAS_RUN',
    'SGLexicalNoSpecialChars', 'ISpObjectTokenCategory',
    'SPSHORTCUTPAIR', 'ISpRecoContext', 'SPWORDTYPE',
    'DISPID_SRGIsPronounceable', 'SPRULESTATE', 'SVEPhoneme',
    'DISPID_SPRFirstElement', 'SPVISEMES', 'DISPID_SPPChildren',
    'DISPID_SPPEngineConfidence', 'tagSPPROPERTYINFO', 'ISpeechVoice',
    'DISPID_SRCEFalseRecognition', 'DISPID_SRSetPropertyString',
    'DISPID_SMSALineId', 'ISpPhraseAlt', 'DISPID_SRCEInterference',
    'SpeechVisemeType', 'SRCS_Disabled', 'SPWORDPRONOUNCEABLE',
    'SpeechPartOfSpeech', 'DISPID_SRGetFormat',
    'DISPID_SRGCmdLoadFromObject', 'SREAllEvents',
    'DISPID_SpeechWaveFormatEx', 'ISpPhrase',
    'DISPID_SpeechMemoryStream', 'SRSActive', 'SPSEMANTICFORMAT',
    'SGRSTTRule', 'DISPID_SPIEngineId', 'SAFT22kHz16BitMono',
    'SPGS_EXCLUSIVE', 'DISPID_SLPsCount', 'SVP_2', 'DISPID_SRGId',
    'SAFTADPCM_22kHzMono', 'SPPS_LMA', 'SPVOICESTATUS',
    'SPEI_TTS_BOOKMARK', 'SPCS_ENABLED', 'STCRemoteServer',
    'SP_VISEME_14', 'SAFTGSM610_11kHzMono', 'SAFT8kHz16BitMono',
    'tagSPTEXTSELECTIONINFO', 'SPEI_RESERVED3', 'DISPID_SPIRule',
    'DISPID_SVEAudioLevel', 'SPDKL_LocalMachine',
    'SAFT44kHz8BitStereo', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SRGDictationLoad', 'DISPID_SpeechRecoResult2', 'SBOPause',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'ISpeechPhraseRules',
    'SpeechRunState', 'DISPID_SRSCurrentStreamPosition', 'SPBO_AHEAD',
    'UINT_PTR', 'SVEBookmark', 'SVSFNLPSpeakPunc',
    'DISPID_SpeechVoiceEvent', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SPPNumberOfElements', 'DISPID_SVEStreamStart',
    'ISpRecognizer', 'DISPID_SRCRetainedAudioFormat', 'SP_VISEME_10',
    'SVSFPersistXML', 'DISPID_SRRRecoContext', 'SPBOOKMARKOPTIONS',
    'DISPID_SRRTLength', 'SVEWordBoundary', 'ISpNotifyTranslator',
    'DISPID_SRRGetXMLErrorInfo', 'SAFTCCITT_uLaw_44kHzStereo',
    'SRAImport', 'DISPID_SLPPhoneIds', 'DISPID_SpeechObjectToken',
    'SAFTCCITT_ALaw_8kHzStereo', 'SVP_4', 'DISPID_SWFEBitsPerSample',
    'SDKLCurrentConfig', 'DISPID_SRGCmdSetRuleState', 'SPSFunction',
    'SPEI_PHONEME', 'DISPID_SRRDiscardResultInfo',
    'SPFM_OPEN_READONLY', 'SPWORDPRONUNCIATION', 'SAFT8kHz8BitMono',
    'SpWaveFormatEx', 'DISPID_SRCEPropertyNumberChange',
    'STSF_AppData', 'SVP_16', 'SpeechVisemeFeature', 'SREAdaptation',
    'ISpStream', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SRCEPhraseStart', 'DISPID_SVEventInterests',
    'SPRECOSTATE', 'SREHypothesis', 'SPLO_DYNAMIC', 'DISPID_SLWsItem',
    'ISpeechGrammarRuleStateTransitions', 'SP_VISEME_2',
    'DISPID_SOTRemove', 'DISPID_SPPParent', 'SpeechDisplayAttributes',
    'SPAR_High', 'DISPID_SAFGuid', 'SAFT8kHz8BitStereo',
    'SPEI_TTS_PRIVATE', 'SPINTERFERENCE_TOOLOUD',
    'SAFTADPCM_22kHzStereo', 'DISPID_SRCEBookmark',
    'DISPID_SPRules_NewEnum', 'DISPID_SPAPhraseInfo',
    'DISPID_SPIRetainedSizeBytes', 'SpMMAudioEnum',
    'DISPID_SASFreeBufferSpace', 'SPPHRASERULE',
    'DISPID_SRCCreateGrammar', 'IEnumString',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SRIsUISupported',
    'SGRSTTEpsilon', 'SPLO_STATIC', 'SP_VISEME_21',
    'DISPID_SRGDictationSetState', 'DISPID_SVGetVoices',
    'ISpeechPhraseProperties', 'SAFT16kHz16BitMono', 'SP_VISEME_5',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SBSFormat',
    'eLEXTYPE_PRIVATE3', 'DISPID_SASState', 'DISPID_SpeechVoice',
    'SpFileStream', 'DISPID_SVSPhonemeId', 'SpVoice',
    'DISPID_SGRSAddSpecialTransition', 'SPCONTEXTSTATE',
    'DISPID_SPPBRestorePhraseFromMemory', 'SAFTCCITT_ALaw_44kHzMono',
    'SpLexicon', 'SPEVENTSOURCEINFO', 'eLEXTYPE_PRIVATE16',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SVEStartInputStream', 'SpeechPropertyResourceUsage', 'SASClosed',
    'SDTDisplayText', 'SAFT32kHz16BitMono', 'DISPID_SRCRecognizer',
    'DISPID_SRCESoundStart', 'eWORDTYPE_DELETED',
    'DISPID_SDKSetLongValue',
    'SpeechPropertyNormalConfidenceThreshold', 'SPEI_VOICE_CHANGE',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SRCVoicePurgeEvent',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SPCLangId',
    'ISpAudio', 'SpNotifyTranslator', 'SAFT16kHz8BitMono',
    'SPDKL_CurrentUser', 'SAFTGSM610_8kHzMono',
    'DISPID_SRCRetainedAudio', 'DISPID_SWFEFormatTag', 'SPBO_NONE',
    'SPINTERFERENCE_TOOFAST', 'SSTTTextBuffer',
    'SAFTCCITT_ALaw_22kHzMono', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SAFT22kHz16BitStereo', 'DISPID_SDKSetBinaryValue'
]

_check_version('1.1.14', 1610563340.727251)
